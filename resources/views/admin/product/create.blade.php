                ...
                <div class="card-body">
                    <form method="post" action="{{ route('admin.productstore') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="height: 500px;" class="form-control" placeholder="Write something" id="description" name="description">{{ old('description') }}</textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="old_price" type="number" name="old_price" min="0"
                                placeholder="Enter price" value="{{ old('old_price') }}" class="form-control">
                        </div>
