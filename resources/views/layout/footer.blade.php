    ...
    <div class="section">
        ...
        <div class="container">
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            <li><a href="#"><i class="fa fa-map-marker"></i>75A Tô Hiệu, Hiệp Tân, Tân Phú, Thành
            ...
            <div class="row">
                <div class="col-md-12">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.5314083248873!2d106.62339117570329!3d10.770551359300708!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752c203461f629%3A0xa4f6eb4e744dabf9!2zQ2h1bmcgQ8awIDhYIMSQ4bqnbSBTZW4!5e0!3m2!1svi!2s!4v1731732803219!5m2!1svi!2s"
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <span class="copyright">
                        ...
                        </script> All rights reserved | The Website is made with <i class="fa fa-heart-o"
                            aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">THT Team</a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </span>
                </div>
            </div>
                        ...
                        if (data.length > 0) {
                            $.each(data, function(index, item) {
                                $('#search-results').append(
                                    ...
                                    '" style=""><img src="' + item.image +
                                    '" width="50px" height="50px" alt="">&ensp;' +
                                    item.name +
                                    '</a><br />'
                                );
                            });
