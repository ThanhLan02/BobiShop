                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{route('user.updatequantitycart',$key->id)}}" method="post">
                                @csrf
                                <input type="number" name="quantity" style="width: 40px;" value="{{$key->quantity}}">
                                <button type="submit" name="send" style="border-radius: 50%;" value="send" class="btn btn-primary align-center"><i class="fa fa-pencil"></i></button>
                            </form>
                        </td>
                        ...
                        <td class="text-center">
                            <form action="{{route('user.deletesinglecart',$key->id)}}" method="post">
                                @csrf
                                <button type="submit" name="send" value="send" class="btn btn-primary align-center" style="border-radius: 50%;">Xóa</button>
                            </form>
                        </td>
