        ...
        <div class="container">
            ...
            <div class="row">
                <form method="post" action="{{ route('user.payment_cash') }}">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="billing-details">
                            ...
                            <div class="form-group">
                                <input class="input" id="name" type="text" name="name"
                                    placeholder="Enter your name" value="{{ $user->name }}" onchange="copyValue()">
                            </div>
                            <div class="form-group">
                                <input class="input" id="email" type="email" name="email" placeholder="Email"
                                    value="{{ $user->email }}" onchange="copyValue2()">
                            </div>
                            <div class="form-group">
                                <input class="input" id="phone" type="tel" name="phone" placeholder="Phone"
                                    value="{{ $user->phone }}" onchange="copyValue3()">
                            </div>
                        </div>
                        <!-- /Billing Details -->
                        ...
                        <div class="shiping-details">
                            ...
                            <div class="input-checkbox">
                                ...
                                <label for="shiping-address">
                                    <span></span>
                                    Ấn vào để chọn địa chỉ giao hàng khác!
                                </label>
                                <div class="caption">
                                    <div class="form-group">
                                        <br />
                        ...
                        <div class="order-notes">
                            ...
                            <textarea class="input" id="messages" placeholder="Lời nhắn" name="messages" onchange="copyValue5()"></textarea>
                        </div>
                        <!-- /Order notes -->
                    </div>
                ...
                <form action="{{ route('user.paymentmomo') }}" method="post">
                    {{ csrf_field() }}
                    <input type="text" style="display: none;" id="name2" name="name2"
                        value="{{ $user->name }}">
                    <input type="text" style="display: none;" id="phone2" name="phone2"
                        value="{{ $user->phone }}">
                    <input type="text" style="display: none;" id="email2" name="email2"
                        value="{{ $user->email }}">
                    <input type="text" style="display: none;" id="address2" name="address2"
                        value="{{ $user->address }}">
                    ...
                    <input type="text" style="display: none;" id="amount" name="amount"
                        value="{{ $tongtien }}">
                    <button name="payUrl" type="submit" class="primary-btn order-submit" style="width: 100%;">Thanh
                        toán MOMO</button>
                </form>
            </div>
            <!-- /Order Details -->
                ...
                if (province_id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#district').empty();
                            $('#ward')
                                .empty(); // Xóa danh sách phường/xã khi thay đổi tỉnh/thành phố
                            $('#address').empty();
                            $('#address2').empty();
