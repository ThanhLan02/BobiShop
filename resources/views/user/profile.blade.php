        ...
        <div class="col-md-12">
            <div id="product-tab">
                ...
                <ul class="tab-nav">
                    ...
                    <li><a data-toggle="tab" href="#tab2">Đổi mật khẩu</a></li>
                </ul>
                <!-- /product tab nav -->
                                                    ...
                                                    <div class="input-checkbox">
                                                        ...
                                                        <div class="caption">
                                                            <div class="form-group">
                                                                ...
                                                                <br />
                                                                <label for="inputTitle" class="col-form-label">Street
                    ...
                    <div id="tab2" class="tab-pane fade in">
                        <div class="row">
                            <form action="{{ route('user.updatepassword') }}" method="POST">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="inputTitle" class="col-form-label">Mật khẩu cũ <span
                                                class="text-danger">*</span></label>
                                        <input id="inputTitle" type="password" name="oldpassword"
                                            placeholder="Nhập mật khẩu cũ" value="{{ old('oldpassword') }}"
                                            class="form-control">
                                        @error('oldpassword')
                                    ...
                                    <div class="form-group">
                                        <label for="inputTitle" class="col-form-label">Mật khẩu mới <span
                                                class="text-danger">*</span></label>
                                        <input id="inputTitle" type="password" name="newpassword"
                                            placeholder="Nhập mật khẩu mới" value="{{ old('oldpassword') }}"
                                            class="form-control">
                                        @error('newpassword')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="inputTitle" class="col-form-label">Nhập lại mật khẩu mới <span
                                                class="text-danger">*</span></label>
                                        <input id="inputTitle" type="password" name="renewpassword"
                                            placeholder="Nhập lại mật khẩu mới" value="{{ old('oldpassword') }}"
                                            class="form-control">
                                        @error('renewpassword')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
