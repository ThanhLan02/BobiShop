            ...
            <div class="col-md-5">
                <form action="{{ route('many-add-to-cart',$product->id) }}" method="POST">
                    ...
                    <div class="product-details">
                        ...
                        <div>
                            <h3 class="product-price">{{number_format($product->new_price, 0)}} VNĐ <del class="product-old-price">{{number_format($product->old_price, 0)}} VNĐ</del></h3>
                        ...
                        <ul class="product-links">
                            <li><a href="#">Loại : {{$product->category->name}}</a></li>
                            <li><a href="#">Hãng : {{$product->brand->name}}</a></li>
                        </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div id="reviews">
                                        ...
                                        <div class="text-center">{{$reviews->links('pagination::bootstrap-4')}}</div>
                                    </div>
                                </div>
                                <!-- /Reviews -->
                                ...
                                <!-- Review Form -->
                                <div class="col-md-3">
                                    <form class="review-form" action="{{route('user.submitreview')}}" method="POST">
                                        @csrf
                                        <div id="review-form">
                                            <input name="product_id" style="display: none;" value="{{$product->id}}" type="text">
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="product">
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-name"><a href="product_detail/{{$key->id}}">{{$key->name}}</a></h3>
                            @if($key->discount != null || $key->discount > 0)
                            <h4 class="product-price">{{number_format($key->new_price, 0)}} VNĐ</h4> <del class="key-old-price">{{number_format($key->old_price, 0)}} VNĐ</del>
                            @else
