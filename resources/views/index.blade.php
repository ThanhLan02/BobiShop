                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        ...
                        <div class="shop-body">
                            ...
                            <a href="/productbycatename/BEYBLADE" class="cta-btn">XEM THỬ <i
                                            ...
                                            <div class="product">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h3 class="product-name"><a
                                                            href="product_detail/{{ $product->id }}">{{ $product->name }}</a>
                                                    </h3>
                                                    @if ($product->discount != null)
                                                        <h4 class="product-price">
                                                            {{ number_format($product->new_price, 0) }} VNĐ <del
                                                                class="product-old-price">{{ number_format($product->old_price, 0) }}
                                                                VNĐ</del></h4>
                                                    @else
                                                        <h4 class="product-price">
                                                            {{ number_format($product->old_price, 0) }} VNĐ</h4>
                                                    @endif
                            ...
                            @foreach ($product_new_list_1 as $key)
                                <div class="product-widget">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name"><a
                                                href="{{ route('home.product_detail', $key->id) }}">{{ $key->name }}</a>
                                        </h3>
                                        @if ($key->discount > 0 && $key->discount != null)
                                            <h4 class="product-price">{{ number_format($key->new_price, 0) }} <del
                                                    class="product-old-price">{{ number_format($key->old_price, 0) }}
                                                    VNĐ</del></h4>
                                        @else
